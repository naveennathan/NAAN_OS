...
/* puts character onto current screen */
void keyboard_putc(uint8_t c);
/* puts character onto scheduled screen */
void putc(uint8_t c);
/* clears screen */
void clear(void);
...
/* Added this function in header file so it's accessible to tests.c */
